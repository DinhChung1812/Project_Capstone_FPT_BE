...
public class DishFormulaVo {
    ...
    public DishFormulaVo(Integer dishID, String dishName, String region, String createDate, Integer formulaID, String formulaDescribe, String verifier, String summary) {
        this.dishID = dishID;
        this.region = region;
        this.dishName = dishName;
        this.createDate = createDate;
